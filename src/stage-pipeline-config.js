...
const STAGE_PIPELINE_CONFIG = Object.freeze([
  ...
  },
  {
    ...
    roleHint: '下一阶段是 plan，建议派 SA agent 做架构设计',
  },
  {
    stageId: 'plan',
    role: 'architecture',
    ...
    roleHint: '下一阶段是 plan-review-gate，建议派 audit agent 审查设计',
  },
  {
    stageId: 'plan-review-gate',
    role: 'review',
    tier: 'audit',
    timeout: 1200,
    isReviewPhase: true,
  ...
  },
  {
    ...
    cycleCondition: null,
    advanceCondition: 'passed',
    entryCriteria: 'plan-review-gate 通过',
    exitCriteria: '代码实现完成，通过本地测试',
    roleHint: '下一阶段是 implement-review-gate，建议派 audit agent 做代码审计',
  },
  {
    stageId: 'implement-review-gate',
    role: 'audit',
    tier: 'audit',
    timeout: 1200,
    isReviewPhase: true,
    ...
    roleHint: '下一阶段是 regression，建议派 audit agent 做回归测试',
  },
  {
    stageId: 'regression',
    role: 'audit',
    ...
    cycleCondition: null,
    advanceCondition: 'passed',
    entryCriteria: 'implement-review-gate 通过',
    exitCriteria: '回归测试全部通过',
  ...
  },
  {
    ...
    exitCriteria: '部署成功，包/服务可用',
    roleHint: '下一阶段是 verify，建议派 audit agent 做发布后验证',
  },
  {
    stageId: 'verify',
    role: 'audit',
